...
using ThePrimaryBlog.Data;
using ThePrimaryBlog.Models;

namespace ThePrimaryBlog.Controllers
{
    public class BlogsController : Controller
    {
        ...
        // GET: Blogs/SearchForm
        public IActionResult SearchForm()
        {
            return View();
        }

        // POST: Blogs/SearchResults
        public async Task<IActionResult> SearchResults(string SearchPhrase)
        {
            return View(await _context.Blog.Where(Blog => Blog.Title.Contains(SearchPhrase) || Blog.Content.Contains(SearchPhrase)).ToListAsync());
        }
